    ...
    public class LocationFactory: ILocationFactory
    {
        ...
        private Location.Layer GenerateBricks(SizeF size)
        {
            ...
            bricks.Add(new MovingBrick(
                ...
                new []
                {
                    new MovingBrick.MovePhase(new PointF(7.5f * _game.BlockSize, size.Height - 2.5f * _game.BlockSize), 50, TimeSpan.Zero),
                    new MovingBrick.MovePhase(new PointF(11.5f * _game.BlockSize, size.Height - 2.5f * _game.BlockSize), 100, TimeSpan.Zero)
                }
            ));
            ...
            bricks.Add(new MovingBrick(
                ...
                new[]
                {
                    new MovingBrick.MovePhase(new PointF(15.5f * _game.BlockSize, size.Height - 1.5f * _game.BlockSize), 75, TimeSpan.FromSeconds(1)),
